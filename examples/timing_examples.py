...
logging.basicConfig(filename="ntp_service_operation.txt", level=logging.DEBUG)
...
def test_2():
    ...
    processes = {
        "process": {
            ...
            "sources": {"ntp": {"type": "x", "func": source_thread_target},},
            "actuators": {},
        }
    }

    connections = {"process": {"ntp": [("process", "in")]}}

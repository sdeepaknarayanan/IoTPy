...
def filter_then_square(sequence, filter_threshold):
    return [element ** 2 for element in sequence if element < filter_threshold]
...
def pass_data_from_one_process_to_another():
    ...
    processes = {
        "source_process": {
            ...
            "sources": {"sequence": {"type": "i", "func": source_thread_target},},
            "actuators": {},
        },
        "output_process": {
            "in_stream_names_types": [("in", "i")],
...
def pass_data_from_one_process_to_another_v2():
    ...
    processes = {
        "source_process": {
            ...
            "compute_func": copy_in_to_out,
            "sources": {"sequence": {"type": "f", "func": read_file_thread_target},},
            "actuators": {},
        },
        "output_process": {
            "in_stream_names_types": [("in", "f")],
...
def test_multicore_with_single_process():
    ...
    connections = {"process": {"sequence": [("process", "in")]}}
...
def test_1():
    ...
    processes = {
        "source_process": {
            ...
            "out_stream_names_types": [("out", "i")],
            "compute_func": f,
            "sources": {"acceleration": {"type": "i", "func": source_thread_target},},
            "actuators": {},
        },
...
def test_2():
    ...
    # Functions wrapped by agents
    def f(in_streams, out_streams):
        multiply_and_add(in_streams[0], out_streams[0], multiplicand=2, addend=1)
...
def test_4():
    ...
    processes = {
        ...
        "merge_process": {
            "in_stream_names_types": [("in_multiply", "i"), ("in_square", "i")],
            "out_stream_names_types": [],
            "compute_func": m,
            "sources": {},
        },
    ...
    connections = {
        ...
        "multiply_process": {"out": [("merge_process", "in_multiply")]},
        "square_process": {"out": [("merge_process", "in_square")]},
        "merge_process": {},
    }

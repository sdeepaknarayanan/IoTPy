...
def shorten_list_of_list_of_files(list_of_list_of_files, start_ptr, end_ptr):
    shortened_list_of_list_of_files = []
    for list_of_files in list_of_list_of_files:
        shortened_list_of_files = []
        for filename in list_of_files:
            shortened_list_of_files.append(
                shorten_file(filename, "Short_" + filename, start_ptr, end_ptr)
            )
...
if __name__ == "__main__":
    ...
    ## args = sys.argv
    delay_start_of_file(filename=args[1], short_filename=args[2], start_ptr=args[3])

...
def examples_merge():
    ...
    assert recent_values(t) == [100, 102, 104, 106, 108, 110, 112, 114, 116, 118]
    ...
    run()
    # Check values of output streams.
    assert recent_values(t) == [100, 103, 106, 109, 112, 115, 118, 121, 124, 127]
    ...
    run()
    # Check values of output streams.
    assert recent_values(t) == [200, 203, 206, 209, 212, 215, 218, 221, 224, 227]
    ...
    y.extend(list(range(100, 120)))
    run()
    assert recent_values(t) == [200, 204, 208, 212, 216, 220, 224, 228, 232, 236]
    ...
    run()
    # Check values of output streams.
    assert recent_values(t) == [403, 415, 427, 439, 451, 463, 475, 487, 499, 511]
    ...
    y.extend(list(range(100, 120)))
    run()
    assert recent_values(t) == [403, 416, 429, 442, 455, 468, 481, 494, 507, 520]

...
class multi_test(unittest.TestCase):
    def test_multi(self):
        ...
        v.extend(np.arange(10.0, 16.0, 1.0))
        scheduler.step()
        assert np.array_equal(recent_values(u), np.array([0.0, 1.0, 2.0, 3.0, 4.0]))
        ...
        assert np.array_equal(recent_values(y), np.array([5.0, 6.0, 7.0, 8.0, 9.0]))
        assert np.array_equal(recent_values(z), np.array([0.0, 1.0, 2.0, 3.0, 4.0]))
        ...
        assert np.array_equal(recent_values(u), np.array([0, 1, 2, 3, 4]))
        assert np.array_equal(recent_values(v), np.array([10, 11, 12, 13, 14, 15, 16]))
        assert np.array_equal(recent_values(x), np.array([10, 11, 12, 13, 14]))
        assert np.array_equal(recent_values(y), np.array([10, 13, 16, 19, 22]))
